export const responses = {
  ...
  discount: {
    ...
    text:
      "قیمت‌های درج‌شده در کانال شما شاپ، قیمت نهایی و مقطوع هستند.\n\n" +
      "تمامی اجناس از قبل با تخفیف عرضه شده‌اند و قیمت‌ها پایین‌تر از قیمت بازار و قیمت مصرف‌کننده در نظر گرفته شده‌اند.\n\n" +
      "به همین دلیل تخفیفِ مجدد روی قیمت‌های کانال اعمال نمی‌شود."
  },
