 ...
 * - location: ارسال مختصات (فعلاً برای پروژه استفاده نمی‌شود)
 *
...
export const responses = {
  // آدرس طبق درخواست: فقط متن، بدون location و بدون keyboard.
  address: {
    type: "text",
  ...
  support: {
    type: "text",
    text: "برای پشتیبانی با شماره 09339968627 تماس بگیرید."
  },
